...
import model.MyElipse;

public class ElipseCreationWindow {
	public ElipseCreationWindow(JFrame frame, JButton drawButton, JButton save, JButton load,
		...
		addButton.addActionListener(new ActionListener(){
       	 public void actionPerformed(ActionEvent e) {
		       	...
		       	MyElipse elipse= new MyElipse(readCenterX, readCenterY, readXLength, readYLength, colorReader,fillCheck );
		       	receiver.onReceiveShape(elipse);
