...
public class CircleCreationWindow {
	public CircleCreationWindow(JFrame frame, JButton drawButton, JButton save, JButton load,
		...
		addButton.addActionListener(new ActionListener(){
       	 public void actionPerformed(ActionEvent e) {
		       	 ...
		       	 fieldReader=radius.getText();
		       	 int radius=Integer.parseInt(fieldReader);
		       	...
		       	MyCircle circle= new MyCircle(readCenterX, readCenterY, radius, colorReader,fillCheck);
		       	receiver.onReceiveShape(circle);
		       	
		       	elipsePanel.setVisible(false);
